package com.spark.devproj.sparkDataframeAPIs.miscellaneous
...
object ComplexTypesDemo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df1 = spark.read.schema(schema).json(CommonUtils.getInputFilePath("data/"))
    ...
    df4.write.mode(SaveMode.Overwrite).parquet(CommonUtils.getOutputFilePath("output/"))
